             ...
             <v-layout row wrap>
               ...
               >
                 <v-card flat tile class="d-flex">
                   <v-img
                     :src="`http://10.5.0.7:62/replace-sys/imagenes_productos/` + info.clave_interna + `/` + info.clave_interna + `-00` + n + `.jpg`"
                     :lazy-src="`http://10.5.0.7:62/replace-sys/imagenes_productos/` + info.clave_interna + `/` + info.clave_interna + `-00` + n + `.jpg`"
                        aspect-ratio="1"
